...
{
    public interface IDALPostSingle
    {
        #region 分页获取晒单列表
        /// <summary>
        /// 分页获取晒单列表
        ...
        /// <returns></returns>
        DataSet GetPostSinglePageList( int FIdx, int EIdx, int order, int sortID, int isCount, out int totalCount );
        /// <summary>
        /// 分页获取晒单列表
        /// </summary>
        /// <param name="FIdx">开始序号</param>
        ...
        /// <param name="totalCount">总记录数</param>
        /// <returns></returns>
        DataSet mGetUserWebPagePostList( int userID, int FIdx, int EIdx, DateTime beginTime, DateTime endTime, int isCount, out int totalCount );
        #endregion
        ...
        /// <returns></returns>
        DataSet GetMemberCenterForUserPostSingle( int FIdx, int EIdx, int userID, DateTime beginTime, DateTime endTime, int isCount, out int postCount, out int unPostCount );
        #endregion
        ...
        /// <returns></returns>
        DataSet GetMemberCenterForUserUnPostSingle( int FIdx, int EIdx, int userID, DateTime beginTime, DateTime endTime, int isCount, out int count );
        #endregion
        ...
        /// <returns></returns>
        int CheckPostSingleByID( int userID, int codeID );
        #endregion
        ...
        /// <returns></returns>
        DataSet GetPostSingleByCodeID( int codeID );
        #endregion
        ...
        /// <param name="totalCount">返回总记录数</param>
        /// <returns></returns>
         DataSet appGetMemberCenterPostListByUserID( int userID, int state, int isStat, DateTime beginTime, DateTime endTime, int FIdx, int EIdx, int isCount, out int totalCount );
        #endregion
    }
}
