...
namespace wcfNSYGShop
{
    ...
    public partial interface IWCFContract
    {
        ...
        /// <returns></returns>
        [OperationContract]
        bool UpdateUserPoints( int userID, int pointNum, int logType, DateTime logTime, int refrenceID, string logDesc );
        #endregion
        ...
        /// <returns></returns>
        [OperationContract]
        bool ApplyUserBrokerageToAccount( int userID, decimal money );
        #endregion
